	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column is-vertically-aligned-stretch" style="flex-basis:50%">
			...
			<div class="wp-block-group" style="min-height:100%">
				...
				<p class="has-heading-font-family has-x-large-font-size" style="line-height:1.2"><?php echo esc_html_x(
    	...
    	'Headline for the About pattern',
    	'twentytwentyfour',
    ); ?></p>
				<!-- /wp:paragraph -->
     	...
     	'Description for the About pattern',
     	'twentytwentyfour',
     ); ?></p>
					<!-- /wp:paragraph -->
