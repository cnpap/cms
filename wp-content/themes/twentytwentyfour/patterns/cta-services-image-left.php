...
<div class="wp-block-group alignfull has-accent-5-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
    ...
    ); ?>/assets/images/abstract-geometric-art.webp" alt="<?php esc_attr_e(
	...
	'twentytwentyfour',
   	...
   	'Sample heading of the services pattern',
   	'twentytwentyfour',
   ); ?></h2>
			<!-- /wp:heading -->
   	...
   	'Sample description of the services pattern',
   	'twentytwentyfour',
   ); ?></p>
			<!-- /wp:paragraph -->
     	...
     	'Our services',
     	'Sample button text to view the services',
     	'twentytwentyfour',
     ); ?></a>
				</div>
				<!-- /wp:button -->
