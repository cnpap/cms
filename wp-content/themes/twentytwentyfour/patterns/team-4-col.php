...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group">
		...
		<h2 class="wp-block-heading has-text-align-center has-xx-large-font-size"><?php echo esc_html_x(
  	'Meet our team',
  	'Sample heading for the team pattern',
  	'twentytwentyfour',
  ); ?></h2>
		<!-- /wp:heading -->
  	...
  	'Sample descriptive text of the team pattern',
  	'twentytwentyfour',
  ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	...
	<div class="wp-block-columns alignwide" style="padding-right:0;padding-left:0">
		...
		<div class="wp-block-column">
     	...
     	'twentytwentyfour',
				...
				<!-- wp:paragraph {"align":"center","fontSize":"small"} -->
				<p class="has-text-align-center has-small-font-size"><?php echo esc_html_x(
    	'Founder, CEO & Architect',
    	'Sample role of a team member',
    	'twentytwentyfour',
    ); ?></p>
				<!-- /wp:paragraph -->
			</div>
