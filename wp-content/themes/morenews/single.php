...
<div class="section-block-upper">
    <div id="primary" class="content-area">
        <main id="main" class="site-main">
            ...
            } elseif ($social_share_icon_opt == 'side') {
            ...
            while (have_posts()):
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class('af-single-article'); ?>>
                    ...
                    <div class="entry-content-wrap read-single <?php echo esc_attr(
                    	$wrap_class,
                    ); ?>">
                        ...
                        <?php
                        $social_share_icon_opt = morenews_get_option(
                        	'single_post_social_share_view',
                        );
                        if (
                        	$social_share_icon_opt == 'after-content' ||
                        	$social_share_icon_opt == 'side'
                        ) {
                        ...
                        <?php if (has_post_thumbnail($post->ID)):
                        	$show_featured_image = morenews_get_option(
                        	...
                        	if ($show_featured_image): ?>
                                <div class="read-img pos-rel">
                                    ...
                                    if ($thumbnail_id) {
                                    	...
                                    	if (
                                    		$thumbnail_post &&
                                    		!empty(trim($thumbnail_post->post_excerpt))
                                    	) { ?>
                                            <span class="aft-image-caption">
                                                <p><?php echo esc_html(
                                                	$thumbnail_post->post_excerpt,
                                                ); ?></p>
                                            </span>
                                    <?php }
                                    }
