!(function (t) {
	...
	70: function (t, a) {
		...
		jQuery(document).ready(function (t) {
			...
			var a = !1;
			function e(t) {
				(t.removeClass('installing'), (a = !1));
			}
			((n.install_plugin = function (n, l) {
				((a = !0),
					n.addClass('installing'),
					t.ajax({
						type: 'POST',
				...
				(n.activate_plugin = function (n, l) {
					(n.addClass('installing'),
						t.ajax({
							type: 'POST',
							url: aft_installer_localize.ajax_url,
							...
							success: function (t) {
								(t &&
									...
									'templatespare' === t.plugin
										? n
												.attr('href', t.redirectUrl)
												.removeClass('disabled installed')
												.attr(
													'class',
													'button-primary templatespare primary'
												)
				...
				t(document).on('click', '.aft-plugin-installer a.button', function (e) {
					e.preventDefault();
					var l = t(this),
						i = l.data('slug');
					l.hasClass('disabled') ||
						a ||
						(l.hasClass('install')
							? n.install_plugin(l, i)
							: l.hasClass('activate') && n.activate_plugin(l, i));
				}),
				t('.aft-dismiss-notice').on('click', function () {
					t.ajax({
						type: 'POST',
						url: aft_installer_localize.ajax_url,
						data: {
						...
						success: function (a) {
							'success' === a.status && t('.aft-notice-content-wrapper').remove();
						}
					});
				}),
				t(document).on('click', '.aft-bulk-active-plugin-installer a.button', function (a) {
					...
					(n.addClass('installing'),
						t.ajax({
							...
							success: function (t) {
								'success' === t.status && (window.location.href = t.url);
							}
						}));
				}));
		});
