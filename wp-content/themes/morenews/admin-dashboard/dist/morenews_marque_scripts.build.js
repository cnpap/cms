!(function (e) {
	...
	72: function (e, t) {
		var i;
		(((i = jQuery).fn.marquee = function (e) {
			return this.each(function () {
				var t,
					...
					a,
					s,
					o = i.extend({}, i.fn.marquee.defaults, e),
					u = i(this),
					d = 3,
					...
					c = function (e, t, i) {
						for (var n = ['webkit', 'moz', 'MS', 'o', ''], r = 0; r < n.length; r++)
							(n[r] || (t = t.toLowerCase()), e.addEventListener(n[r] + t, i, !1));
					},
					f = function () {
						u.timer = setTimeout(V, o.delayBeforeStart);
					},
					m = {
						pause: function () {
							(l && o.allowCss3Support ? t.css(p, 'paused') : i.fn.pause && t.pause(),
				...
				if ('string' != typeof e) {
					...
					if (
						...
						o.startVisible && !o.duplicated
							? ((o._completeDuration =
									...
									o.duration),
								(o.duration = (parseInt(y, 10) / parseInt(v, 10)) * o.duration))
							: (o.duration =
									((parseInt(y, 10) + parseInt(v, 10)) / parseInt(v, 10)) *
									o.duration);
					} else
						((s = u.find('.js-marquee:first').width() + o.gap),
							...
							o.startVisible && !o.duplicated
								? ((o._completeDuration =
										...
										o.duration),
									(o.duration = (parseInt(s, 10) / parseInt(n, 10)) * o.duration))
								: (o.duration =
										((parseInt(s, 10) + parseInt(n, 10)) / parseInt(n, 10)) *
										o.duration));
					if ((o.duplicated && (o.duration = o.duration / 2), o.allowCss3Support)) {
						var b = document.body || document.createElement('div'),
							...
							j = '';
						if (
							(b.style.animation && ((j = '@keyframes ' + x + ' '), (l = !0)),
							!1 === l)
						)
							for (var q = 0; q < S.length; q++)
								if (void 0 !== b.style[S[q] + 'AnimationName']) {
									var O = '-' + S[q].toLowerCase() + '-';
									((I = O + I),
										(p = O + p),
										(j = '@' + O + 'keyframes ' + x + ' '),
										(l = !0));
					...
					var _ = function () {
							t.css('margin-top', 'up' == o.direction ? v + 'px' : '-' + y + 'px');
						},
						C = function () {
							t.css('margin-left', 'left' == o.direction ? n + 'px' : '-' + s + 'px');
						};
					o.duplicated
						? (a
								? o.startVisible
					...
					var V = function () {
						if (
							...
							var e =
								...
								p = t.find('style');
							(0 !== p.length
								? p.filter(':last').html(e)
								: i('head').append('<style>' + e + '</style>'),
							...
							t.animate(r, o.duration, o.easing, function () {
								(u.trigger('finished'), o.pauseOnCycle ? f() : V());
							});
						u.data('runningStatus', 'resumed');
					};
					(u.bind('pause', m.pause),
						...
						l && o.allowCss3Support ? V() : f());
				} else
					i.isFunction(m[e]) &&
						(t || (t = u.find('.js-marquee-wrapper')),
