!(function (e) {
	...
	1: function (e, t, n) {
		...
		const { __: r } = wp.i18n,
			...
			a = '/admin-dashboard/assets/images/af-themes-logo.png',
			i = [
				{
					linkeText: r('Unlock Pro Features', 'morenews'),
					textUrl: 'https://afthemes.com/products/morenews-pro/'
				},
				{
					linkeText: r('Docs', 'morenews'),
					textUrl: 'https://docs.afthemes.com/morenews/'
				},
				{
					linkeText: r('Need Help?', 'morenews'),
					textUrl: 'https://afthemes.com/supports/'
				},
				{
					linkeText: r('Rate This Theme', 'morenews'),
					textUrl: 'https://wordpress.org/support/theme/morenews/reviews/?filter=5'
				}
			],
			o = r('Upgrade to Pro', 'morenews'),
			u = 'https://afthemes.com/products/morenews-pro/';
		r('Need Help?', 'morenews');
	},
	10: function (e, t, n) {
		'use strict';
		e.exports = n(11);
	...
	11: function (e, t, n) {
		...
		function A(e, n) {
			...
			var r = M;
			try {
				for (D(n), O = _(N); null !== O && (!(O.expirationTime > n) || (e && !i())); ) {
					var o = O.callback;
					if (null !== o) {
						((O.callback = null), (M = O.priorityLevel));
						var u = o(O.expirationTime <= n);
						((n = t.unstable_now()),
							'function' == typeof u ? (O.callback = u) : O === _(N) && C(N),
							D(n));
					} else C(N);
					O = _(N);
				}
			...
			(t.unstable_scheduleCallback = function (e, n, i) {
				...
				return (
					...
					u > o
						? ((e.sortIndex = u),
							S(R, e),
							null === _(N) && e === _(R) && (F ? a() : (F = !0), l(U, u - o)))
						: ((e.sortIndex = i), S(N, e), L || I || ((L = !0), r(A))),
					e
				);
			}),
...
*/ var r = Object.getOwnPropertySymbols,
	...
	75: function (e, t, n) {
		...
		const { __: o } = wp.i18n;
		var u = ({
			templatespare_install: e,
			templatespare_active: t,
			page: n,
			message: r,
			currentTheme: l,
			pluginversion: a
			...
			let i = '#',
				u = o('Get Started', 'morenews'),
				c = '_self';
			return (
				'false' !== a &&
					((i = a), (u = o('Update Templatespare', 'morenews')), (c = '_blank')),
				React.createElement(
					React.Fragment,
					null,
					React.createElement(
						'div',
						{ className: 'templatespare-demo templatespare-main-demo' },
						React.createElement(
							'div',
							{ className: 'templatespare-demo-lists-wrapper' },
							React.createElement(
								'div',
								{ className: 'templatespare-section-all-demos' },
								React.createElement(
									'div',
									{ className: 'bs-top-notice' },
									React.createElement(
										'div',
										{ className: 'notice-detils-wrapper' },
										React.createElement(
											'h3',
											{ className: 'bs-title' },
											o('Easy Website Building with Zero Code', 'morenews')
										),
										React.createElement(
											'p',
											{ className: 'bs-title' },
											o(
												'Quickly create a stunning website with 1000+ pre-designed demo sites for blogs, news, and eCommerce. Seamlessly import demo content and customize your site using Elementor, Gutenberg, or your favorite page builder. No coding skills required—just drag, drop, and go live in minutes. Plus, enjoy multilingual support for a global audience! Powered by TemplateSpare.'
											)
										),
										React.createElement(
											'a',
											...
											React.createElement('strong', null, u),
											React.createElement(
												'svg',
												{
													viewBox: '0 0 24 24',
									...
									React.createElement(
										'div',
										{ className: 'notice-img-wrapper' },
										React.createElement('img', {
											src: afDashboardData.starter_sites,
											alt: 'morenews'
										})
									)
								)
		...
		var s = ({
			...
			let o = '#',
				u = c('Get Started', 'morenews'),
				s = '_self';
			return (
				'false' !== a &&
					((o = a),
					(u = c(
						'pro' === i ? 'Update Blockspare Pro' : 'Update Blockspare',
						'morenews'
					)),
					(s = '_blank')),
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'blockspare-dashboard' },
						React.createElement(
							'div',
							{ className: 'blockspare-dashboard__containers' },
							React.createElement(
								'div',
								{ className: 'bs-layout-tab-content settings-tab-content-wrapper' },
								React.createElement(
									'div',
									{ className: 'bs-layouts-wrappper' },
									React.createElement(
										'div',
										{ className: 'bs-top-notice' },
										React.createElement(
											...
											React.createElement(
												...
												{ className: 'bs-title' },
												c(
													'Powerful Gutenberg Blocks & Patterns',
													'morenews'
												)
											),
											React.createElement(
										...
										React.createElement(
											...
											{ className: 'notice-img-wrapper' },
											React.createElement('img', {
												src: afDashboardData.block_patterns,
												alt: 'morenews'
											})
										)
									)
		...
		var d = ({
				...
				let o = '#',
					u = f('Get Started', 'morenews'),
					c = '_self';
				return (
					'false' !== a &&
						((o = a),
						(u = f(
							'pro' === i ? 'Update Elespare Pro' : 'Update Elespare',
							'morenews'
						)),
						(c = '_blank')),
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									...
									{
										className:
											'bs-layout-tab-content settings-tab-content-wrapper'
									},
									React.createElement(
										'div',
										{ className: 'bs-layouts-wrappper' },
										React.createElement(
											...
											React.createElement(
												...
												React.createElement(
													...
													{ className: 'bs-title' },
													f(
														'Professional Sites with Elementor',
														'morenews'
													)
												),
												React.createElement(
											...
											React.createElement(
												...
												{ className: 'notice-img-wrapper' },
												React.createElement('img', {
													src: afDashboardData.template_kits,
													alt: 'morenews'
												})
											)
										)
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						null,
						React.createElement('img', {
							src: afDashboardData.aflogoUrl + p.b,
							alt: ''
						})
					),
					React.createElement(
						...
						p.c &&
							p.c.map((e, t) =>
								React.createElement(
									'a',
									{ key: t, href: e.textUrl, target: '_blank' },
									e.linkeText
								)
							)
					)
		...
		var g = ({
			...
			let o = 'aft-bulk-active-plugin-installer';
			return (
				'false' !== a && (o = 'aft-bulk-update-plugin-installer'),
				React.createElement(
					'div',
					{ className: 'aft-general-info-link ' + o },
		...
		document.addEventListener('DOMContentLoaded', () => {
			var e = 'templatespare-plugin-install-activate';
			if (
				void 0 !== document.getElementById(e) &&
				null !== document.getElementById(e) &&
				(s = document.getElementById(e))
			) {
				var t = s.getAttribute('install'),
					n = s.getAttribute('activate'),
					r = s.getAttribute('data-plugin-page'),
					a = s.getAttribute('message'),
					o = s.getAttribute('current-theme'),
					u = s.getAttribute('data-class'),
					c = s.getAttribute('isPro');
				i.a.render(
					l.a.createElement(g, {
						templatespare_install: t,
						templatespare_active: n,
						page: r,
						message: a,
						currentTheme: o,
						pluginversion: u,
			...
			var s;
			e = 'morenews-starter-sites-lists';
			void 0 !== document.getElementById(e) &&
				null !== document.getElementById(e) &&
				(s = document.getElementById(e)) &&
				i.a.render(
					l.a.createElement(
						...
						l.a.createElement('div', {
							id: 'templatespare-template-collcetion-dashboard'
						})
					),
					document.getElementById(e)
				);
	...
	9: function (e, t, n) {
		...
		function M() {
			if (N) {
				var e = N,
					t = R;
				if (((R = N = null), z(e), t)) for (e = 0; e < t.length; e++) z(t[e]);
			}
		}
		function I(e, t) {
			return e(t);
			...
			(null !== l
				...
				r || null === l
					? (function (e) {
							return (
								!!B.call(H, e) ||
								(!B.call(Q, e) && (W.test(e) ? (H[e] = !0) : ((Q[e] = !0), !1)))
							);
					...
					if (null === l) Nt(e, r);
						...
						!(function (e, t, n, r, l) {
							switch (t) {
								...
								case 'pointerover':
									var a = l.pointerId;
									return (xt.set(a, Rt(xt.get(a) || null, e, t, n, r, l)), !0);
								case 'gotpointercapture':
									return (
										(a = l.pointerId),
										Tt.set(a, Rt(Tt.get(a) || null, e, t, n, r, l)),
										!0
									);
							}
							return !1;
						...
						a
							? (er &&
									...
									(ir || a !== nr.compositionStart
										? a === nr.compositionEnd && ir && (l = Vn())
										: ((An = 'value' in (Un = r) ? Un.value : Un.textContent),
											(ir = !0))),
		...
		function fr(e, t, n) {
			return (((e = Qn.getPooled(sr.change, e, t, n)).type = 'change'), O(n), Dn(e), e);
		}
		var dr = null,
			pr = null;
		function mr(e) {
		...
		C && (vr = ct('input') && (!document.documentMode || 9 < document.documentMode));
		var Tr = {
				eventTypes: sr,
		...
		var Nr = 0,
			...
			Fr = {
				...
				extractEvents: function (e, t, n, r, l) {
					...
					for (c = o, o = []; r && r !== c && (null === (i = r.alternate) || i !== c); )
						(o.push(r), (r = zn(r)));
		...
		function Ql(e) {
			return (null === Ll ? ((Ll = [e]), (Fl = El(Cl, $l))) : Ll.push(e), Ol);
		}
		function Hl() {
			if (null !== Fl) {
				var e = Fl;
		...
		function $l() {
			if (!Dl && null !== Ll) {
				...
				try {
					...
					throw (null !== Ll && (Ll = Ll.slice(e + 1)), El(Cl, Hl), t);
				} finally {
					Dl = !1;
				}
			}
		...
		function ga(e, t, n, r, l, a, i) {
			return 'function' == typeof (e = e.stateNode).shouldComponentUpdate
				...
				: !t.prototype || !t.prototype.isPureReactComponent || !Ar(n, r) || !Ar(l, a);
		}
		function va(e, t, n) {
			var r = !1,
				l = sl,
			...
			return (
				'object' == typeof a && null !== a
					...
					: ((l = hl(t) ? pl : fl.current),
						(a = (r = null != (r = t.contextTypes)) ? ml(e, l) : sl)),
				(t = new t(n, a)),
		...
		function xa(e) {
			...
			function c(e, t, n, r) {
				return null !== t && t.elementType === n.type
					...
					: (((r = Cu(n.type, n.key, n.props, null, e.mode, r)).ref = ka(e, t, n)),
						(r.return = e),
						r);
			}
			function s(e, t, n, r) {
			...
			function d(e, t, n) {
				...
				if ('object' == typeof t && null !== t) {
					switch (t.$$typeof) {
						case ee:
							return (
								((n = Cu(t.type, t.key, t.props, null, e.mode, n)).ref = ka(
									e,
									null,
									t
								)),
							...
							e: {
								...
								a.type === ne
									? (((r = Pu(a.props.children, e.mode, u, a.key)).return = e),
										(e = r))
									: (((u = Cu(a.type, a.key, a.props, null, e.mode, u)).ref = ka(
											e,
											r,
											a
										)),
		...
		function za(e, t) {
			switch ((cl(Na, t), cl(Pa, e), cl(Ca, _a), (e = t.nodeType))) {
				case 9:
				case 11:
		...
		function Ka(e, t, n, r, l, a) {
			if (
				...
				(t.updateQueue = null),
				(t.expirationTime = 0),
				(Ua.current = null === e || null === e.memoizedState ? gi : vi),
				(e = n(r, l)),
				t.expirationTime === ja)
			) {
				a = 0;
		...
		function qa() {
			...
			return (null === Ba ? (Va.memoizedState = Ba = e) : (Ba = Ba.next = e), Ba);
		}
		function Ya() {
			if (null === Wa) {
				var e = Va.alternate;
			...
			var t = null === Ba ? Va.memoizedState : Ba.next;
			if (null !== t) ((Ba = t), (Wa = e));
			else {
				...
				((e = {
					...
					null === Ba ? (Va.memoizedState = Ba = e) : (Ba = Ba.next = e));
			}
			return Ba;
		}
		function Ga(e, t) {
				...
				do {
					...
					if (s < ja) {
						...
						(null === u ? ((o = u = f), (a = r)) : (u = u.next = f),
							s > Va.expirationTime && ((Va.expirationTime = s), iu(s)));
					} else
						(null !== u &&
							(u = u.next =
								{
		...
		function mi(e, t, n) {
			...
			if (
				...
				((Qa = !0), (l.expirationTime = ja), (Va.expirationTime = ja));
			else {
				if (
					0 === e.expirationTime &&
		...
		function _i(e) {
			...
			if (5 !== e.tag || ('head' !== t && 'body' !== t && !yn(t, e.memoizedProps)))
				for (t = wi; t; ) (Ei(e, t), (t = kn(t.nextSibling)));
			if ((Si(e), 13 === e.tag)) {
		...
		function zi(e, t, n, r, l) {
			...
			return (
				...
				(r = Ka(e, t, n, r, a, l)),
				null === e || Ni
					? ((t.effectTag |= 1), Ri(e, t, r, l), t.child)
		...
		function Mi(e, t, n, r, l, a) {
			return null !== e && Ar(e.memoizedProps, r) && e.ref === t.ref && ((Ni = !1), l < a)
		...
		function Li(e, t, n, r, l) {
			...
			return (
				...
				(n = Ka(e, t, n, r, a, l)),
				null === e || Ni
					? ((t.effectTag |= 1), Ri(e, t, n, l), t.child)
					: ((t.updateQueue = e.updateQueue),
						(t.effectTag &= -517),
						e.expirationTime <= l && (e.expirationTime = 0),
						Ki(e, t, l))
		...
		function $i(e, t, n) {
			var r = t.pendingProps,
				l = r.revealOrder,
				a = r.tail;
			if ((Ri(e, t, r.children, n), 0 != (2 & (r = La.current))))
			...
			if ((cl(La, r), 0 == (2 & t.mode))) t.memoizedState = null;
			else
				switch (l) {
					case 'forwards':
		...
		function Yi(e, t, n) {
			...
			switch (t.tag) {
				...
				case 5:
					(Ia(t), (n = Ra(Na.current)));
					var a = t.type;
					if (null !== e && null != t.stateNode)
						(ji(e, t, a, r, n), e.ref !== t.ref && (t.effectTag |= 128));
					else {
						if (!r) {
							if (null === t.stateNode) throw Error(i(166));
							return null;
						}
						if (((e = Ra(Ca.current)), _i(t))) {
							...
							switch (
								...
								case 'select':
									...
									break;
								case 'textarea':
									(ze(e, r), (c = Re(e, r)), Kt('invalid', e), un(n, 'onChange'));
									break;
								default:
									c = r;
							}
							...
							: ((n = null !== r),
								...
								n &&
									...
									0 != (1 & La.current)
										? Co === wo && (Co = ko)
										: ((Co !== wo && Co !== ko) || (Co = Eo),
											0 !== Oo && null !== To && (Mu(To, _o), Iu(To, Oo)))),
								(n || r) && (t.effectTag |= 4),
								null)
					);
				case 4:
				...
				case 17:
					return (hl(t.type) && gl(), null);
				case 19:
					if ((ul(La), null === (r = t.memoizedState))) return null;
					if (((a = 0 != (64 & t.effectTag)), null === (o = r.rendering))) {
						if (a) qi(r, !1);
						else if (Co !== wo || (null !== e && 0 != (64 & e.effectTag)))
								...
								if (null !== (e = Fa(o))) {
									for (
										...
										((o = n),
											...
											(r = r.sibling));
									return (cl(La, (1 & La.current) | 2), t.child);
								}
								o = o.sibling;
							}
					} else {
		...
		function ho(e, t, n) {
			...
			return (
				null !== a &&
					...
					(n.callback = function () {
						'function' != typeof r &&
							(null === Uo ? (Uo = new Set([this])) : Uo.add(this), Ji(e, t));
						var n = t.stack;
		...
		function qo(e, t) {
			if (50 < Bo) throw ((Bo = 0), (Qo = null), Error(i(185)));
			if (null !== (e = Yo(e, t))) {
				var n = jl();
				(1073741823 === t
					? 0 != (8 & xo) && 0 == (48 & xo)
		...
		function Yo(e, t) {
			...
			return (null !== l && (To === l && (iu(t), Co === Eo && Mu(l, _o)), Iu(l, t)), l);
		}
		function Go(e) {
		...
		function Xo(e) {
			if (0 !== e.lastExpiredTime)
				((e.callbackExpirationTime = 1073741823),
					...
					(e.callbackNode = Ql(Jo.bind(null, e))));
			else {
				var t = Go(e),
					n = e.callbackNode;
				if (0 === t)
		...
		function Zo(e, t) {
			if (((Ho = 0), t)) return (Lu(e, (t = $o())), Xo(e), null);
			var n = Go(e);
			if (0 !== n) {
				if (((t = e.callbackNode), 0 != (48 & xo))) throw Error(i(327));
				if ((hu(), (e === To && n === _o) || nu(e, n), null !== So)) {
					...
					if ((Jl(), (xo = r), (yo.current = l), 1 === Co))
						throw ((t = Po), nu(e, n), Mu(e, n), Xo(e), t);
					if (null === So)
						switch (
		...
		function Jo(e) {
			var t = e.lastExpiredTime;
			if (((t = 0 !== t ? t : 1073741823), 0 != (48 & xo))) throw Error(i(327));
			if ((hu(), (e === To && t === _o) || nu(e, t), null !== So)) {
				...
				if ((Jl(), (xo = n), (yo.current = r), 1 === Co))
					throw ((n = Po), nu(e, t), Mu(e, t), Xo(e), n);
		...
		function au(e, t) {
			(e < No && 2 < e && (No = e), null !== t && e < Ro && 2 < e && ((Ro = e), (zo = t)));
		}
		function iu(e) {
			e > Oo && (Oo = e);
		}
		...
		function su(e) {
			...
			do {
				...
				if (((e = So.return), 0 == (2048 & So.effectTag))) {
					...
					if (null !== (t = Gi(So))) return ((t.effectTag &= 2047), t);
		...
		function pu(e, t) {
			...
			if (
						...
						for (o = e, u = t; null !== Lo; ) {
							...
							switch (1038 & w) {
								case 2:
									...
									break;
								case 6:
									(uo(Lo), (Lo.effectTag &= -3), so(Lo.alternate, Lo));
									break;
								case 1024:
									Lo.effectTag &= -1025;
									break;
								case 1028:
									((Lo.effectTag &= -1025), so(Lo.alternate, Lo));
									break;
								case 4:
									so(Lo.alternate, Lo);
									break;
				...
				(($t = !!hn), (gn = hn = null), (e.current = n), (Lo = l));
				do {
					try {
						for (w = e; null !== Lo; ) {
							var x = Lo.effectTag;
			...
			if (Ao) ((Ao = !1), (jo = e), (Vo = t));
			else
				for (Lo = l; null !== Lo; ) ((t = Lo.nextEffect), (Lo.nextEffect = null), (Lo = t));
			if (
				(0 === (t = e.firstPendingTime) && (Uo = null),
				1073741823 === t ? (e === Qo ? Bo++ : ((Bo = 0), (Qo = e))) : (Bo = 0),
				'function' == typeof ku && ku(n.stateNode, r),
				Xo(e),
				Fo)
			)
				throw ((Fo = !1), (e = Do), (Do = null), e);
			return (0 != (8 & xo) || Hl(), null);
		}
		function mu() {
			for (; null !== Lo; ) {
				var e = Lo.effectTag;
				(0 != (256 & e) && to(Lo.alternate, Lo),
					0 == (512 & e) ||
						Ao ||
						((Ao = !0),
						Bl(97, function () {
		...
		function hu() {
			if (90 !== Vo) {
				var e = 97 < Vo ? 97 : Vo;
				return ((Vo = 90), Wl(e, gu));
			}
		}
		function gu() {
			if (null === jo) return !1;
			var e = jo;
			if (((jo = null), 0 != (48 & xo))) throw Error(i(331));
			var t = xo;
		...
		function vu(e, t, n) {
			(ua(e, (t = mo(e, (t = Xi(n, t)), 1073741823))),
				...
				for (var n = e.return; null !== n; ) {
					...
					if (1 === n.tag) {
						...
						if (
							...
							(ua(n, (e = ho(n, (e = Xi(t, e)), 1073741823))),
		...
		function bu(e, t, n) {
			...
			(null !== r && r.delete(t),
				To === e && _o === n
					? Co === Eo || (Co === ko && 1073741823 === No && Al() - Io < 500)
						? nu(e, _o)
						: (Mo = !0)
					: Ou(e, n) &&
			...
			switch (((t.expirationTime = 0), t.tag)) {
				...
				case 1:
					return (
						(r = t.type),
						(l = t.pendingProps),
						Fi(e, t, r, (l = t.elementType === r ? l : ql(r, l)), n)
					);
				case 3:
