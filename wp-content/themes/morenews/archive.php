...
get_header(); ?>
        ...
        <main id="main" class="site-main">
            ...
            <?php if (have_posts()): ?>
                ...
                if ($current_term) {
                	...
                	if (
                		$archive_layout == 'archive-layout-masonry' ||
                		$archive_layout == 'archive-layout-full'
                	) {
	...
	'aft-first-post-full latest-posts-full col-1 float-l pad',
); ?> >
                     ...
                     * called content-___.php (where ___ is the Post Format name) and that will be used instead.
                     */
                		else:get_template_part('template-parts/content', get_post_format());endif;
