...
if (!function_exists('morenews_show_date_on_header')):
	...
	{
		if (
			'header-layout-compressed' != $control->manager->get_setting('header_layout')->value()
		) {
			return true;
		} else {
			return false;
...
if (!function_exists('morenews_global_site_mode_status')):
	...
	function morenews_global_site_mode_status($control)
	{
		if (
			'aft-default-mode' ==
			$control->manager->get_setting('global_site_mode_setting')->value()
		) {
			return true;
		} else {
			return false;
...
if (!function_exists('morenews_global_site_mode_dark_status')):
	...
	{
		if (
			'aft-dark-mode' == $control->manager->get_setting('global_site_mode_setting')->value()
		) {
			return true;
		} else {
			return false;
...
if (!function_exists('morenews_main_navigation_background_color_mode_status')):
	...
	function morenews_main_navigation_background_color_mode_status($control)
	{
		if (
			'custom-color' ==
			$control->manager->get_setting('main_navigation_background_color_mode')->value()
		) {
			return true;
		} else {
			return false;
...
if (!function_exists('morenews_main_banner_3_col_section_status')):
	...
	function morenews_main_banner_3_col_section_status($control)
	{
		if (
			'layout-1' ==
				$control->manager->get_setting('select_main_banner_layout_section')->value() ||
			'layout-3' ==
				$control->manager->get_setting('select_main_banner_layout_section')->value()
		) {
			return true;
...
if (!function_exists('morenews_main_banner_section_filterby_cat_status')):
	...
	{
		if (
			'cat' == $control->manager->get_setting('select_main_banner_carousel_filterby')->value()
		) {
			return true;
		} else {
			return false;
...
if (!function_exists('morenews_banner_latest_post_section_filterby_cat_status')):
	...
	{
		if (
			'cat' == $control->manager->get_setting('select_banner_latest_post_filterby')->value()
		) {
			return true;
		} else {
			return false;
...
if (!function_exists('morenews_banner_latest_post_section_filterby_tag_status')):
	...
	{
		if (
			'tag' == $control->manager->get_setting('select_banner_latest_post_filterby')->value()
		) {
			return true;
		} else {
			return false;
...
if (!function_exists('morenews_main_banner_section_filterby_tag_status')):
	...
	{
		if (
			'tag' == $control->manager->get_setting('select_main_banner_carousel_filterby')->value()
		) {
			return true;
		} else {
			return false;
...
if (!function_exists('morenews_sidebar_trending_post_section_filterby_cat_status')):
	...
	function morenews_sidebar_trending_post_section_filterby_cat_status($control)
	{
		if (
			'cat' ==
			$control->manager->get_setting('select_sidebar_trending_post_filterby')->value()
		) {
			return true;
		} else {
			return false;
...
if (!function_exists('morenews_main_banner_carousel_status')):
	...
	function morenews_main_banner_carousel_status($control)
	{
		if (
			'banner-carousel' ==
			$control->manager->get_setting('select_main_banner_section_mode')->value()
		) {
			return true;
		} else {
			return false;
	...
	function morenews_main_banner_carousel_layout_status($control)
	{
		if (
			'carousel-layout-default' ==
				$control->manager->get_setting('select_main_banner_carousel_option')->value() ||
			'carousel-layout-4' ==
				$control->manager->get_setting('select_main_banner_carousel_option')->value()
		) {
			return true;
...
if (!function_exists('morenews_tabbed_mode_status')):
	...
	{
		if (
			'default' == $control->manager->get_setting('select_tab_section_mode')->value() ||
			'trending' == $control->manager->get_setting('select_tab_section_mode')->value()
		) {
			return true;
		} else {
			return false;
...
if (!function_exists('morenews_featured_news_category_section_status')):
	...
	function morenews_featured_news_category_section_status($control)
	{
		if (
			'category' ==
			$control->manager->get_setting('show_featured_category_page_section')->value()
		) {
			return true;
		} else {
			return false;
...
if (!function_exists('morenews_featured_news_pages_section_status')):
	...
	{
		if (
			'page' == $control->manager->get_setting('show_featured_category_page_section')->value()
		) {
			return true;
		} else {
			return false;
...
if (!function_exists('morenews_display_author_status')):
	...
	function morenews_display_author_status($control)
	{
		if (
			'show-date-author' ==
				$control->manager->get_setting('global_post_date_author_setting')->value() ||
			'show-author-only' ==
				$control->manager->get_setting('global_post_date_author_setting')->value()
		) {
			return true;
...
if (!function_exists('morenews_frontpage_content_alignment_status')):
	...
	function morenews_frontpage_content_alignment_status($control)
	{
		if (
			'align-content-left' ==
				$control->manager->get_setting('frontpage_content_alignment')->value() ||
			'align-content-right' ==
				$control->manager->get_setting('frontpage_content_alignment')->value()
		) {
			return true;
...
if (!function_exists('morenews_archive_layout_first_post_full_status')):
	...
	{
		if (
			'archive-layout-list' == $control->manager->get_setting('archive_layout')->value() ||
			'archive-layout-grid' == $control->manager->get_setting('archive_layout')->value()
		) {
			return true;
		} else {
			return false;
...
if (!function_exists('morenews_mailchimp_subscriptions_status')):
	...
	{
		if (
			true == $control->manager->get_setting('footer_show_mailchimp_subscriptions')->value()
		) {
			return true;
		} else {
			return false;
...
if (!function_exists('morenews_footer_instagram_posts_status')):
	...
	{
		if (
			true == $control->manager->get_setting('footer_show_instagram_post_carousel')->value()
		) {
			return true;
		} else {
			return false;
...
if (!function_exists('morenews_disable_header_image_tint_overlay_status')):
	...
	{
		if (
			'default' == $control->manager->get_setting('select_header_image_mode')->value() ||
			'full' == $control->manager->get_setting('select_header_image_mode')->value()
		) {
			return true;
		} else {
			return false;
