...
$wp_customize->add_control(
	new MoreNews_Section_Title($wp_customize, 'site_background_color_section_title', [
...
$wp_customize->add_control(
	new MoreNews_Simple_Notice_Custom_Control($wp_customize, 'global_color_section_notice', [
		'description' => esc_html__(
			'Body Background Color (Dark Mode) will be applied for this mode.',
			'morenews',
		),
		'section' => 'colors',
		'priority' => 10,
...
$wp_customize->add_control(
	new WP_Customize_Color_Control($wp_customize, 'dark_background_color', [
...
$wp_customize->add_control(
	new MoreNews_Section_Title($wp_customize, 'secondary_color_section_title', [
...
$wp_customize->add_control(
	new MoreNews_Section_Title($wp_customize, 'site_title_font_section_title', [
...
// Setting - global content alignment of news.
$wp_customize->add_setting('global_font_family_type', [
	'default' => $morenews_default['global_font_family_type'],
	'capability' => 'edit_theme_options',
	'sanitize_callback' => 'morenews_sanitize_select',
]);

$wp_customize->add_control('global_font_family_type', [
