...
$wp_customize->add_control('select_main_banner_order', [
	...
	'active_callback' => function ($control) {
		return morenews_main_banner_section_status($control) &&
...
$wp_customize->add_control(
	new MoreNews_Section_Title($wp_customize, 'main_banner_panel_section_title', [
...
$wp_customize->add_control(
	new MoreNews_Dropdown_Taxonomies_Control($wp_customize, 'select_slider_news_category', [
		'label' => esc_html__('Select Category', 'morenews'),
		'description' => esc_html__(
			'Select category to be shown on main slider section',
			'morenews',
		),
		'section' => 'frontpage_main_banner_section_settings',
...
$wp_customize->add_control(
	new MoreNews_Dropdown_Taxonomies_Control($wp_customize, 'select_slider_news_tag', [
...
$wp_customize->add_control(
	new MoreNews_Section_Title($wp_customize, 'editors_picks_panel_section_title', [
...
$wp_customize->add_control(
	new MoreNews_Dropdown_Taxonomies_Control($wp_customize, 'select_editors_picks_news_category', [
...
$wp_customize->add_control(
	new MoreNews_Dropdown_Taxonomies_Control($wp_customize, 'select_editors_picks_news_tag', [
		'label' => esc_html__('Select Tag', 'morenews'),
		'section' => 'frontpage_main_banner_section_settings',
		'type' => 'dropdown-taxonomies',
		'taxonomy' => 'post_tag',
...
$wp_customize->add_control(
	new MoreNews_Section_Title($wp_customize, 'trending_post_panel_section_title', [
...
$wp_customize->add_control(
	new MoreNews_Dropdown_Taxonomies_Control($wp_customize, 'select_trending_post_category', [
		'label' => esc_html__('Select', 'morenews'),
		'section' => 'frontpage_main_banner_section_settings',
		'type' => 'dropdown-taxonomies',
		'taxonomy' => 'category',
...
$wp_customize->add_control(
	new MoreNews_Dropdown_Taxonomies_Control($wp_customize, 'select_trending_post_tag', [
		'label' => esc_html__('Select Tag', 'morenews'),
		'section' => 'frontpage_main_banner_section_settings',
		'type' => 'dropdown-taxonomies',
		'taxonomy' => 'post_tag',
...
$wp_customize->add_control(
	new MoreNews_Section_Title($wp_customize, 'banner_latest_post_panel_section_title', [
...
$wp_customize->add_control(
	new MoreNews_Dropdown_Taxonomies_Control($wp_customize, 'select_banner_latest_post_category', [
		'label' => esc_html__('Select', 'morenews'),
		'section' => 'frontpage_main_banner_section_settings',
		'type' => 'dropdown-taxonomies',
		'taxonomy' => 'category',
...
$wp_customize->add_control(
	new MoreNews_Dropdown_Taxonomies_Control($wp_customize, 'select_latest_post_tag', [
		'label' => esc_html__('Select Tag', 'morenews'),
		'section' => 'frontpage_main_banner_section_settings',
		'type' => 'dropdown-taxonomies',
		'taxonomy' => 'post_tag',
...
$wp_customize->add_control(
	new MoreNews_Section_Title($wp_customize, 'popular_post_panel_section_title', [
...
$wp_customize->add_control(
	new MoreNews_Dropdown_Taxonomies_Control($wp_customize, 'select_popular_post_category', [
		'label' => esc_html__('Select', 'morenews'),
		'section' => 'frontpage_main_banner_section_settings',
		'type' => 'dropdown-taxonomies',
		'taxonomy' => 'category',
...
$wp_customize->add_control(
	new MoreNews_Dropdown_Taxonomies_Control($wp_customize, 'select_popular_post_tag', [
		'label' => esc_html__('Select Tag', 'morenews'),
		'section' => 'frontpage_main_banner_section_settings',
		'type' => 'dropdown-taxonomies',
		'taxonomy' => 'post_tag',
...
//section title
$wp_customize->add_setting('update_post_panel_section_title', [
	'sanitize_callback' => 'sanitize_text_field',
]);

$wp_customize->add_control(
	new MoreNews_Section_Title($wp_customize, 'update_post_panel_section_title', [
...
$wp_customize->add_setting('main_update_news_section_title', [
	'default' => $morenews_default['main_update_news_section_title'],
	'capability' => 'edit_theme_options',
	'sanitize_callback' => 'sanitize_text_field',
]);
$wp_customize->add_control('main_update_news_section_title', [
	'label' => esc_html__('Section Title ', 'morenews'),
	'section' => 'frontpage_main_banner_section_settings',
	'type' => 'text',
	'priority' => 100,
...
// Setting - select_main_banner_section_mode.
$wp_customize->add_setting('select_update_post_filterby', [
	'default' => $morenews_default['select_update_post_filterby'],
	'capability' => 'edit_theme_options',
	'sanitize_callback' => 'morenews_sanitize_select',
]);

$wp_customize->add_control('select_update_post_filterby', [
	'label' => esc_html__('Filter Posts By', 'morenews'),
	'section' => 'frontpage_main_banner_section_settings',
	'type' => 'select',
	'choices' => [
...
// Setting - drop down category for slider.
$wp_customize->add_setting('select_update_post_category', [
...
$wp_customize->add_control(
	new MoreNews_Dropdown_Taxonomies_Control($wp_customize, 'select_update_post_category', [
		'label' => esc_html__('Select', 'morenews'),
		'section' => 'frontpage_main_banner_section_settings',
		'type' => 'dropdown-taxonomies',
		'taxonomy' => 'category',
...
// Setting - drop down category for slider.
$wp_customize->add_setting('select_update_post_tag', [
...
$wp_customize->add_control(
	new MoreNews_Dropdown_Taxonomies_Control($wp_customize, 'select_update_post_tag', [
		'label' => esc_html__('Select Tag', 'morenews'),
		'section' => 'frontpage_main_banner_section_settings',
		'type' => 'dropdown-taxonomies',
		'taxonomy' => 'post_tag',
...
$wp_customize->add_control(
	new morenews_Dropdown_Taxonomies_Control($wp_customize, 'select_flash_news_category', [
...
$wp_customize->add_control(
	new MoreNews_Dropdown_Taxonomies_Control($wp_customize, 'select_featured_news_category', [
...
for ($morenews_i = 1; $morenews_i <= 3; $morenews_i++) {
	...
	$wp_customize->add_control('featured_post_list_section_title_' . $morenews_i, [
		'label' => esc_html__('Section Title', 'morenews'),
		'section' => 'frontpage_featured_post_list_settings',
		'type' => 'text',
		'priority' => 130,
	...
	$wp_customize->add_control(
		new MoreNews_Dropdown_Taxonomies_Control(
			$wp_customize,
			'featured_post_list_category_section_' . $morenews_i,
			[
				'label' => esc_html__('Category', 'morenews'),
				'description' => esc_html__(
					'Select category to be shown on featured section ',
					'morenews',
				),
				'section' => 'frontpage_featured_post_list_settings',
				'type' => 'dropdown-taxonomies',
...
$wp_customize->add_control('frontpage_content_type', [
	...
	'choices' => [
		...
		'frontpage-widgets-and-content' => esc_html__(
			'Page Contents & Front-page Widgets',
			'morenews',
		),
	],
	'priority' => 10,
