...
function morenews_customize_register($wp_customize)
{
	...
	// use get control
	$wp_customize->get_control('header_textcolor')->label = __(
	...
	$wp_customize->add_section(
		new MoreNews_Customize_Section_Upsell($wp_customize, 'theme_upsell', [
...
{
	wp_enqueue_script(
		'morenews-customize-controls',
		get_template_directory_uri() . '/assets/customizer-admin.js',
		['customize-controls'],
	);

	wp_enqueue_style(
		'morenews-customize-controls-style',
		get_template_directory_uri() . '/assets/customizer-admin.css',
	);
}
