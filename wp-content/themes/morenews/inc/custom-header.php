...
function morenews_custom_header_setup()
{
	add_theme_support(
		'custom-header',
		apply_filters('morenews_custom_header_args', [
			'default-image' => '',
...
if (!function_exists('morenews_header_style')):
	...
	{
		$morenews_header_image_tint_overlay = morenews_get_option(
    ...
    <style type="text/css">
      <?php
      if ($morenews_header_image_tint_overlay): ?>body .af-header-image.data-bg:before {
        opacity: 0;
      }
