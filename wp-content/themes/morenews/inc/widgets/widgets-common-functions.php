...
if (!function_exists('morenews_render_posts')):
	function morenews_render_posts(
		$morenews_number_of_posts,
		$morenews_category,
		$morenews_filterby
	) {
		$morenews_main_banner_layout_section = morenews_get_option(
...
if (!function_exists('morenews_render_tabbed_posts')):
	function morenews_render_tabbed_posts(
		$tab_id,
		$latest_title,
		$latest_post_filterby,
		$latest_category,
		$latest_color_class,
		$popular_title,
		$popular_post_filterby,
		$popular_category,
		$popular_color_class,
		$update_title,
		$update_post_filterby,
		$update_category,
		$update_color_class,
		$number_of_posts
	) {
    ...
    <div class="tabbed-container three-column-tabs">
      <div class="tabbed-head">
        <ul class="nav nav-tabs af-tabs tab-warpper" role="tablist">
          <li class="tab tab-recent <?php echo esc_attr(
          	$latest_color_class,
          ); ?>" role="presentation">
          ...
          <li class="tab tab-popular <?php echo esc_attr(
          	$popular_color_class,
          ); ?>" role="presentation">
