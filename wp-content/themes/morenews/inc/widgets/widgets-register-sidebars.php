...
function morenews_widgets_init()
{
	register_sidebar([
		...
		'description' => esc_html__(
			'Add widgets for frontpage banner section advertisement.',
			'morenews',
		),
		'before_widget' => '<div id="%1$s" class="widget morenews-widget %2$s">',
		'after_widget' => '</div>',
		'before_title' =>
			'<h2 class="widget-title widget-title-1"><span class="heading-line-before"></span><span class="heading-line">',
