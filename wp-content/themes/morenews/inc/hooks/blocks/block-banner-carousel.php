...
if (
	$morenews_main_banner_layout_section == 'layout-5' ||
	$morenews_main_banner_layout_section == 'layout-6'
) {
...
<div class="af-widget-carousel aft-carousel">
  <div class="slick-wrapper af-banner-carousel af-banner-carousel-1 common-carousel af-cat-widget-carousel <?php echo esc_html(
  	$morenews_carousel_class,
  ); ?>"
    data-slick='<?php echo wp_kses_post($morenews_carousel_args_encoded); ?>'>
    <?php
    $morenews_slider_posts = morenews_get_posts(
    	$morenews_number_of_slides,
    	$morenews_slider_category,
    	$morenews_filterby,
    );
