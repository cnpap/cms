		...
		if ('' != $morenews_banner_advertisement) { ?>
            <div class="banner-promotions-wrapper">
                <?php if ('' != $morenews_banner_advertisement):
                	...
                	$morenews_banner_advertisement = wp_get_attachment_image(
                		$morenews_banner_advertisement,
                		'full',
                	);
                	$morenews_banner_advertisement_url = morenews_get_option(
                		'banner_advertisement_section_url',
                	);
                	$morenews_banner_advertisement_url = isset($morenews_banner_advertisement_url)
                		? esc_url($morenews_banner_advertisement_url)
                		: '#';
                	?>
