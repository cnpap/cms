	...
	function morenews_banner_exclusive_posts()
	{
      ...
      <div class="aft-popular-tags">
        <div class="container-wrapper">
          <?php
          $morenews_show_popular_tags_title = morenews_get_option(
          ...
          morenews_list_popular_taxonomies(
          	$morenews_select_popular_tags_mode,
          	$morenews_show_popular_tags_title,
          	$morenews_number_of_popular_tags,
          );
          ?>
        </div>
      </div>
          ...
          <div class="exclusive-posts">
            ...
            <div class="exclusive-slides" dir="ltr">
              ...
              if ($morenews_all_posts->have_posts()): ?>
                <div class='marquee <?php echo esc_attr(
                	$morenews_em_ticker_news_mode,
                ); ?>' data-speed='80000'
                  data-gap='0' data-duplicated='true' data-direction="<?php echo esc_attr(
                  	$morenews_dir,
                  ); ?>">
                  <?php while ($morenews_all_posts->have_posts()):

                  	$morenews_all_posts->the_post();
                  	global $post;
