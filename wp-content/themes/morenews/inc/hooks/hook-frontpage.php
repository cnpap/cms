        ...
        <section class="section-block-upper">
            ...
            <div id="primary" class="content-area">
                <main id="main" class="site-main">
                    ...
                    <?php if ($frontpage_content_type == 'frontpage-widgets-and-content') {
                    	while (have_posts()):
                    		the_post();
            ...
            <?php if (
            	is_active_sidebar('home-sidebar-widgets') &&
            	$frontpage_layout != 'full-width-content'
            ): ?>
                ...
                if ($sticky_sidebar) {
                	$sticky_sidebar_class = morenews_get_option(
                ...
                <div id="secondary" class="sidebar-area <?php echo esc_attr(
                	$sticky_sidebar_class,
                ); ?>">
