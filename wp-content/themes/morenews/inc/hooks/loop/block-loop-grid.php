...
if (!function_exists('morenews_loop_grid')):
	 ...
	 *
	 */
	function morenews_loop_grid(
		$morenews_post_id,
		$morenews_grid_design = 'grid-design-default',
		$morenews_thumbnail_size = 'medium_large',
		$morenews_show_excerpt = false,
		$archive_content_view = 'archive-content-excerpt',
		...
		$morenews_post_thumbnail = morenews_the_post_thumbnail(
    ...
    <div class="pos-rel read-single color-pad clearfix af-cat-widget-carousel <?php echo esc_attr(
    	$morenews_grid_design,
    ); ?> <?php echo esc_attr($morenews_no_thumbnail_class); ?>">
      ...
      <div class="read-img pos-rel read-bg-img">
        <a class="aft-post-image-link" aria-label="<?php echo esc_attr(
        	get_the_title($morenews_post_id, 'morenews'),
        ); ?>" href="<?php the_permalink(); ?>"></a>
        <?php if ($morenews_post_thumbnail) {
      ...
      <div class="pad read-details color-tp-pad">
        ...
        <?php if ($morenews_show_excerpt == true): ?>
          <div class="post-description">
            <?php if ($archive_content_view == 'archive-content-full') {
            	the_content();
            } else {
