...
if (!function_exists('morenews_loop_list')):
	 ...
	 */
	function morenews_loop_list(
		$morenews_post_id,
		$morenews_thumbnail_size = 'thumbnail',
		$morenews_count = 0,
		$show_cat = false,
		$show_meta = true,
		$show_excerpt = false,
		...
		?>
    <div class="af-double-column list-style clearfix aft-list-show-image <?php echo esc_attr(
    	$morenews_no_thumbnail_class,
    ); ?>">
      <div class="read-single color-pad">
        <div class="col-3 float-l pos-rel read-img read-bg-img">
          <a class="aft-post-image-link"
            href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
          <?php // Display the post thumbnail if available
        ...
        <div class="col-66 float-l pad read-details color-tp-pad">
          ...
          <?php if ($show_meta != false): ?>
            <div class="post-item-metadata entry-meta author-links">
              ...
              <?php
          	//morenews_get_comments_views_share($morenews_post_id);
          	?>
            </div>
          <?php endif; ?>
