...
return [
	...
	'categories' => ['morenews'],
	'content' =>
		'<!-- wp:group {"align":"full","className":"row","layout":{"type":"constrained"}} -->
    ...
    <h2 class="wp-block-heading alignfull">' .
		esc_html__('Featured News', 'morenews') .
		'</h2>
    <!-- /wp:heading -->
    ...
    <h2 class="wp-block-heading">' .
		esc_html__('Express Grid', 'morenews') .
		'</h2>
    <!-- /wp:heading -->
    ...
    <h2 class="wp-block-heading">' .
		esc_html__('About Author', 'morenews') .
		'</h2>
    <!-- /wp:heading -->
    ...
    <figure class="wp-block-image aligncenter size-medium is-resized is-style-rounded"><img src="' .
		esc_url(get_template_directory_uri()) .
		'/assets/img/author-profile.jpg" alt="" class="wp-image-552" style="object-fit:cover;width:200px;height:200px" width="200" height="200"/></figure>
    <!-- /wp:image --></div></div><div class="blockspare-profile-column blockspare-profile-content-wrap"><div class="blockspare-section-header-wrapper blockspare-blocks"><div class="blockspare-section-head-wrap blockspare-style1 blockspare-center"><div class="blockspare-title-wrapper"><span class="blockspare-title-dash blockspare-upper-dash"></span><h2 class="blockspare-title">AF themes</h2><span class="blockspare-title-dash blockspare-lower-dash"></span></div><div class="blockspare-subtitle-wrapper"><span class="blockspare-title-dash blockspare-upper-dash"></span><p class="blockspare-subtitle">themes.plugins.support</p><span class="blockspare-title-dash blockspare-lower-dash"></span></div></div></div><div class="blockspare-profile-text blockspare-user-profile-desc"><p>' .
		esc_html__(
			'We mainly focus on quality code and elegant design with incredible support. Our WordPress themes and plugins empower you to create an elegant, professional, and easy-to-maintain website in no time at all. Even on mobile and tablet screens, your website will look great',
			'morenews',
		) .
		'</p></div><ul class="blockspare-social-links blockspare-default-official-color blockspare-social-icon-square blockspare-social-icon-small blockspare-icon-only blockspare-social-icon-solid blockspare-social-links-horizontal"></ul></div></div></div></div></div>
    ...
    <div class="wp-block-group alignfull"><!-- wp:heading {"align":"full"} -->
    <h2 class="wp-block-heading alignfull">' .
		esc_html__('Three Columns', 'morenews') .
		' </h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-group alignwide"><!-- wp:heading -->
    <h2 class="wp-block-heading">' .
		esc_html__('Post Slider', 'morenews') .
		'</h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-group alignwide"><!-- wp:heading {"align":"wide"} -->
    <h2 class="wp-block-heading alignwide">' .
		esc_html__('Connect to Us', 'morenews') .
		'</h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-group alignwide"><!-- wp:heading {"align":"wide"} -->
    <h2 class="wp-block-heading alignwide">' .
		esc_html__('Advertisement', 'morenews') .
		'</h2>
    <!-- /wp:heading -->
    
    <!-- wp:image {"id":1175,"sizeSlug":"medium","linkDestination":"none"} -->
    <figure class="wp-block-image size-medium"><img src="' .
		esc_url(get_template_directory_uri()) .
		'/assets/img/square-promo.jpg" alt="" class="wp-image-1175"/></figure>
    <!-- /wp:image --></div>
    <!-- /wp:group --></div>
    <!-- /wp:column --></div>
    <!-- /wp:columns -->
    ...
    <div class="wp-block-group alignfull"><!-- wp:heading {"align":"full"} -->
    <h2 class="wp-block-heading alignfull">' .
		esc_html__('Post Carousel', 'morenews') .
		'</h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-group alignwide"><!-- wp:heading -->
    <h2 class="wp-block-heading">' .
		esc_html__('Express Tile', 'morenews') .
		'</h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-group alignwide"><!-- wp:heading {"align":"wide"} -->
    <h2 class="wp-block-heading alignwide">' .
		esc_html__('Single Column', 'morenews') .
		' </h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-group"><!-- wp:heading -->
    <h2 class="wp-block-heading">' .
		esc_html__('Categories', 'morenews') .
		'</h2>
    <!-- /wp:heading -->
