...
if (!function_exists('morenews_front_page_main_section')):
	...
	function morenews_front_page_main_section()
	{
		...
		if ($morenews_enable_main_slider):
			...
			if (
				$morenews_banner_layout == 'layout-1' ||
				$morenews_banner_layout == 'layout-2' ||
				$morenews_banner_layout == 'layout-3'
			) {
				...
				$morenews_banner_layout == 'layout-4' ||
				$morenews_banner_layout == 'layout-5' ||
				$morenews_banner_layout == 'layout-6'
			) {
            ...
            <section
                    class="aft-blocks aft-main-banner-section banner-carousel-1-wrap bg-fixed  morenews-customizer <?php echo esc_attr(
                    	$morenews_layout_class,
                    ); ?>"
                    data-background="<?php echo esc_attr($morenews_main_banner_url); ?>">
            <?php do_action('morenews_action_banner_exclusive_posts'); ?>


            <?php if (is_active_sidebar('home-above-main-banner-widgets')): ?>
