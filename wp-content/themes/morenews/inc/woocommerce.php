...
add_filter(
	...
	'morenews_woocommerce_related_products_args',
);
...
if (!function_exists('morenews_woocommerce_cart_icon')) {
	...
	function morenews_woocommerce_cart_icon()
	{
        ...
        <div class="af-cart-icon-and-count dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
            ...
            <span class="item-count"><?php echo esc_html(
            	WC()->cart->get_cart_contents_count(),
            ); ?></span>
        </div>
        <?php
...
function morenews_get_products(
	$number_of_products,
	$show,
	$category = 0,
	$orderby = 'date',
...
if (!function_exists('morenews_woocommerce_template_loop_hooks')) {
	...
	{
		add_action(
			'morenews_woocommerce_template_loop_product_link_open',
			'woocommerce_template_loop_product_link_open',
		);
		add_action(
			'morenews_woocommerce_template_loop_product_link_close',
			'woocommerce_template_loop_product_link_close',
		);
		add_action(
			'morenews_woocommerce_show_product_loop_sale_flash',
			'woocommerce_show_product_loop_sale_flash',
		);
		add_action(
			'morenews_woocommerce_template_loop_product_thumbnail',
			'woocommerce_template_loop_product_thumbnail',
		);
		add_action(
			'morenews_woocommerce_shop_loop_item_title',
			'woocommerce_template_loop_product_title',
		);
		add_action(
			'morenews_woocommerce_after_shop_loop_item_title',
		...
		add_action(
			'morenews_woocommerce_template_loop_add_to_cart',
