...
<?php }
?>
<footer class="site-footer <?php echo esc_attr(
	$sidebar_col_class,
); ?>" data-background="<?php echo esc_attr($morenews_footer_background_url); ?>">
  <?php
...
<?php
$morenews_scroll_to_top_position = morenews_get_option('global_scroll_to_top_position');
if ($morenews_scroll_to_top_position != 'none'): ?>

  <a id="scroll-up" class="secondary-color <?php echo esc_attr(
  	$morenews_scroll_to_top_position,
  ); ?>">
  </a>
<?php endif;
?>
