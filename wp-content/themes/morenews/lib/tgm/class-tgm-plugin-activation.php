					...
					echo '<p>',
						sprintf(
							...
							'<a href="' .
								...
								'">' .
								esc_html__('Return to the Dashboard', 'morenews') .
								'</a>',
						),
						'</p>';
					...
					foreach ($message as $type => $plugin_group) {
						...
						$imploded = empty($linked_plugins)
							...
							: implode(', ', $linked_plugins) .
								' ' .
								esc_html_x('and', 'plugin A *and* plugin B', 'morenews') .
								' ' .
								$last_plugin;
...
if (!class_exists('TGMPA_List_Table')) {
	...
	class TGMPA_List_Table extends WP_List_Table
	{
		...
		public function __construct()
		{
			$this->tgmpa = call_user_func([get_class($GLOBALS['morenews']), 'get_instance']);
		...
		public function column_version($item)
		{
			...
			if ($this->tgmpa->is_plugin_installed($item['slug'])) {
				$installed = !empty($item['installed_version'])
					...
					: _x('unknown', 'as in: "version nr unknown"', 'morenews');
			...
			if (!empty($item['minimum_version'])) {
				$output[] = sprintf(
					'<p><span style="min-width: 32px; text-align: right; float: right;">%1$s</span>' .
						__('Minimum required version:', 'morenews') .
						'</p>',
		...
		{
			echo esc_html__('No plugins to install, update or activate.', 'morenews') .
				' <a href="' .
				esc_url(self_admin_url()) .
				'"> ' .
				esc_html__('Return to the Dashboard', 'morenews') .
...
if (!function_exists('tgmpa_load_bulk_installer')) {
	...
	function tgmpa_load_bulk_installer()
	{
		...
		$tgmpa_instance = call_user_func([get_class($GLOBALS['morenews']), 'get_instance']);
