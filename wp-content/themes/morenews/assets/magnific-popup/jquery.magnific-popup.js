	...
	MagnificPopup.prototype = {
		...
		init: function () {
			...
			mfp.probablyMobile =
				mfp.isAndroid ||
				mfp.isIOS ||
				/(Opera Mini)|Kindle|webOS|BlackBerry|(Opera Mobi)|(Windows Phone)|IRAMPobile/i.test(
					navigator.userAgent
				);
			_document = $(document);
		...
		close: function () {
			...
			if (mfp.st.removalDelay && !mfp.isLowIE && mfp.supportsTransition) {
				mfp._addClassToMFP(RRAMPOVING_CLASS);
				setTimeout(function () {
					mfp._close();
				}, mfp.st.removalDelay);
			} else {
		...
		_close: function () {
			...
			var classesToRemove = RRAMPOVING_CLASS + ' ' + READY_CLASS + ' ';
