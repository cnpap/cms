...
/* @var array[] $apis */
?><div id="loco-auto" class="loco-batch" title="<?php esc_html_e(
	'Auto-translate this file',
	'loco-translate',
); ?>">
    <form action="#">
        <fieldset>
            <select name="api" id="auto-api"><?php foreach ($apis as $a):
            	$api = new Loco_mvc_ViewParams($a); ?> 
