...
if ($result->translated): ?> 
    <div class="panel panel-success">
        ...
        <p>
            ...
            <a href="<?php $result->e('calleeDoc'); ?>" target="_blank"><code><?php $result->e(
	'callee',
); ?></code></a> function.
        </p>
    </div><?php else: ?> 
    <div class="panel panel-warning">
        ...
        <p>
            The <a href="<?php $result->e('calleeDoc'); ?>" target="_blank"><code><?php $result->e(
	'callee',
); ?></code></a> function
...
foreach ($result->matches as $g => $matched):
    ...
    <div class="panel panel-info">
        ...
        <p>
            ...
            <code class="path"><?php $file->e(
            	'relpath',
            ); ?></code> &rarr; <code class="po"><?php $file->e('msgstr'); ?></code>
        </p><?php endforeach;
        if ($group->has('href')): ?> 
        <p>
