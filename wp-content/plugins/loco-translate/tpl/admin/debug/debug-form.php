        ...
        <table class="form-table">
            <tbody>
                <tr>
                    ...
                    <td>
                        <textarea required class="regular-text" name="msgid" rows="4" id="debug-msgid" placeholder="e.g. %s comment"><?php $form->e(
                        	'msgid',
                        ); ?></textarea>
                        <p class="description">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="regular-text" name="msgctxt" id="debug-msgctxt" value="<?php $form->e(
                        	'msgctxt',
                        ); ?>" placeholder="e.g. Comments title" />
                        <p class="description">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="regular-text" name="msgid_plural" id="debug-plural" value="<?php $form->e(
                        	'msgid_plural',
                        ); ?>" placeholder="e.g. %s comments" />
                        <label for="debug-n">n=</label>
                        <input type="number" min="0" name="n" id="debug-n" value="<?php $form->e(
                        	'n',
                        ); ?>" placeholder="<?php $default->e('n'); ?>" />
                        <p class="description">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="regular-text" name="domain" id="debug-domain" value="<?php $form->e(
                        	'domain',
                        ); ?>" placeholder="<?php $default->e('domain'); ?>"/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="regular-text" name="locale" id="debug-locale" value="<?php $form->e(
                        	'locale',
                        ); ?>" placeholder="<?php $default->e('locale'); ?>" />
                ...
                <tr>
                    ...
                    <td>
                        <select name="loader" id="debug-loader"><?php $value = $form['loader']; ?> 
                            ...
                            <option value="plugin"<?php $value === 'plugin' and
                            	(print ' selected'); ?>>
                                load_plugin_textdomain
                            </option>
                            <option value="theme"<?php $value === 'theme' and
                            	(print ' selected'); ?>>
                                load_theme_textdomain
                            </option>
                            <option value="custom"<?php $value === 'custom' and
                            	(print ' selected'); ?>>
                                load_textdomain
                            </option>
                        ...
                        <input type="text" class="regular-text code" name="loadpath" id="debug-loadpath" value="<?php $form->e(
                        	'loadpath',
                        ); ?>" placeholder="" />
                        <p class="description">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="regular-text code" name="jspath" id="debug-jspath" value="<?php $form->e(
                        	'jspath',
                        ); ?>" placeholder="" />
                        <p class="description">
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            <input type="checkbox" name="unhook" value="1"<?php $form->unhook and
                            	(print ' checked'); ?> />
