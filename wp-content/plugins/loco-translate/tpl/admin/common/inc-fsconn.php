...
$help = esc_url(
	apply_filters('loco_external', 'https://localise.biz/wordpress/plugin/manual/filesystem'),
);
...
if ($params->has('fsLocked')): ?> 
    <div class="has-nav panel panel-locked">
        ...
        <nav>
            <a href="<?php echo $help; ?>#wp" target="_blank"><?php esc_html_e(
	'Documentation',
	'loco-translate',
); ?></a>
            <span>|</span>
            <a href="<?php $this->route('config')->e('href'); ?>#loco--fs-protect"><?php esc_html_e(
	'Settings',
	'loco-translate',
); ?></a>
        </nav>
    ...
    <form id="loco-fs" class="has-nav panel panel-locked jshide jsonly">
        <p>
            <strong class="has-icon"><?php esc_html_e('Write protected', 'loco-translate'); ?>:
            </strong>
            <span class="loco-msg">
                <!-- specific reason to be loaded by ajax -->
            </span>
            <span><?php esc_html_e(
            	'Click "Connect" to authenticate with the server',
            	'loco-translate',
            ); ?>.
            </span>
        </p>
        <nav>
            <button type="button" class="button button-small button-primary"><?php esc_html_e(
            	'Connect',
            	'loco-translate',
            ); ?></button>
