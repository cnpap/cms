...
?> 
    <div class="panel panel-warning">
        ...
        <p>
            <a href="<?php $ext->e(
            	'link',
            ); ?>" class="button button-link has-icon icon-add"><?php $ext->e('text'); ?></a>
            <a href="<?php $skip->e(
            	'link',
            ); ?>" class="button button-link has-icon icon-next"><?php $skip->e(
	'text',
); ?></a><?php if ($this->has('conf')): ?> 
            <a href="<?php $conf->e(
            	'link',
            ); ?>" class="button button-link has-icon icon-wrench"><?php $conf->e(
	'text',
); ?></a><?php endif; ?> 
            <a class="button button-link has-icon icon-help" href="<?php echo esc_url(
            	$help,
            ); ?>" target="_blank"><?php esc_html_e('About templates', 'loco-translate'); ?></a>
        </p>
    </div>
