...
?> 
    ...
    <div class="panel">
        ...
        <form action="" method="post" enctype="application/x-www-form-urlencoded" id="loco-poinit"><?php /* @var Loco_mvc_HiddenFields $hidden */
        $hidden->_e(); ?> 
                            ...
                            <fieldset>
                                ...
                                <div>
                                    ...
                                    <select id="loco-select-locale" name="select-locale">
                                        ...
                                        <optgroup label="<?php esc_attr_e(
                                        	'Installed languages',
                                        	'loco-translate',
                                        ); ?>"><?php /* @var Loco_mvc_ViewParams[] $installed */
foreach ($installed as $option): ?> 
                                            <option value="<?php $option->e(
                                            	'value',
                                            ); ?>" data-icon="<?php $option->e(
	'icon',
); ?>"<?php $option->e('selected'); ?>><?php $option->e('label'); ?></option><?php endforeach; ?> 
                                        </optgroup>
                                        <optgroup label="<?php esc_attr_e(
                                        	'Available languages',
                                        	'loco-translate',
                                        ); ?>"><?php /* @var Loco_mvc_ViewParams[] $locales */
	...
	'icon',
                            ...
                            <fieldset class="disabled">
                                <label for="loco-use-selector-0">
                                    <span><input type="radio" name="use-selector" value="0" id="loco-use-selector-0" <?php $params->has(
                                    	'custom',
                                    ) && (print 'checked '); ?>/></span>
                                ...
                                <div>
                                    <span class="lang nolang"></span>
                                    <span class="loco-clearable"><input type="text" maxlength="14" name="custom-locale" value="<?php $params->e(
                                    	'custom',
                                    ); ?>" /></span>
                                </div>
                            </fieldset>
                ...
                <tbody class="loco-paths">   
                    <tr valign="top">
                        ...
                        <td>
                            <a href="<?php /* @var Loco_mvc_ViewParams $help */
                            $help->e(
                            	'href',
                            ); ?>#locations" class="has-icon icon-help" target="_blank" tabindex="-1"><?php $help->e(
	'text',
); ?></a>
                        </td>
                    </tr><?php
                    ...
                    <tr class="compact">
                        ...
                        <td><?php /* @var Loco_mvc_FileParams $choice */
                        ...
                        foreach ($location['paths'] as $choice):
                        	...
                        	?> 
                            <p><?php if ($choice->disabled): ?> 
                                <label class="for-disabled">
                                    <span class="icon icon-lock"></span>
                                    <input type="radio" name="select-path" class="disabled" disabled /><?php else: ?> 
                                <label>
                                    <input type="radio" name="select-path" value="<?php echo $offset; ?>" <?php echo $choice->checked; ?> />
                                    <input type="hidden" name="path[<?php echo $offset; ?>]" value="<?php $choice->e(
	'hidden',
); ?>" /><?php endif; ?> 
                                    <code class="path"><?php $parent->e(
                                    	'relpath',
                                    ); ?>/<?php echo $choice->holder; ?></code>
                                </label>
                            </p><?php
                        endforeach; ?> 
                        </td>
                    ...
                    ?> 
                </tbody><?php if ($params->has('sourceLocale')): ?> 
                <tbody id="loco-copy" data-locale="<?php $params->e('sourceLocale'); ?>">
                    <tr>
                        ...
                        <td>
                            <a href="<?php $help->e(
                            	'href',
                            ); ?>#copy" class="has-icon icon-help" target="_blank" tabindex="-1"><?php $help->e(
	'text',
); ?></a>
                        </td>
                    </tr>
                        ...
                        <td>
                            <p>
                                <label>
                                    ...
                                    <?php $params->f(
                                    	'sourceLocale',
                                    	__('Copy target translations from "%s"', 'loco-translate'),
                                    ); ?> 
                                </label>
                            </p>
                            <p>
            ...
            <p class="submit">
                <button type="submit" class="button button-large button-primary" disabled><?php esc_html_e(
                	'Start translating',
                	'loco-translate',
                ); ?></button>
            </p>
