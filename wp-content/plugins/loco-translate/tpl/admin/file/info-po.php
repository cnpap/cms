...
?> 
    ...
    <div class="panel panel-info">
        <nav>
            <a class="icon only-icon icon-cog" title="Configure" href="<?php $file->e(
            	'configure',
            ); ?>"><span>configure</span></a>
            <a class="icon only-icon icon-download" title="Download" href="<?php $file->e(
            	'download',
            ); ?>"><span>download</span></a>
        </nav>
        <h3>
            <a href="<?php $locale->e('href'); ?>" class="has-lang">
                <span class="<?php $locale->e('icon'); ?>" lang="<?php $locale->e(
	'lang',
); ?>"><code><?php $locale->e('code'); ?></code></span>
        ...
        <dl>
            ...
            <dd><?php $params->e('author'); ?> &mdash; <date><?php $params->date(
 	'potime',
 ); ?></date></dd>
    ...
    <div class="panel panel-success">
        ...
        <p>
    		...
    		self::e(
            	__('PO file has the same source strings as "%s"', 'loco-translate'),
            	$potfile->name,
            ); ?>.
        </p>
    </div><?php // Translators: Where %s is the name of a template file
    		// Translators: Where %s is the name of a template file
    		else: ?> 
    <div class="panel panel-info">
        <h3 class="has-icon">
        ...
        <p>
            <?php self::e(
            	__(
            		'PO file has different source strings to "%s". Try running Sync before making any changes.',
            		'loco-translate',
            	),
            	$potfile->name,
            ); ?> 
