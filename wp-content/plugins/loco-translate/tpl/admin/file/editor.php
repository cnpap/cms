        ...
        <nav class="wp-core-ui">
            <form action="#" id="loco-actions">
                ...
                <fieldset class="loco-clearable">
                    <input type="text" maxlength="100" name="q" id="loco-search" placeholder="<?php $ui->e(
                    	'filter',
                    ); ?>" autocomplete="off" disabled />
                </fieldset>
                <fieldset>
                    <button class="button has-icon only-icon icon-pilcrow" data-loco="invs" disabled title="<?php $ui->e(
                    	'invs',
                    ); ?>">
                        <span><?php $ui->e('invs'); ?></span>
                    </button>
                    <button class="button has-icon only-icon icon-code" data-loco="code" disabled title="<?php $ui->e(
                    	'code',
                    ); ?>">
