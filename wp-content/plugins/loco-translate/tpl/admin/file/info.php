...
?> 
    ...
    </div><?php // Translators: Where %s is the type of file, e.g. "po"
    	// Translators: Where %s is the name (or number) of an operating system user

    	elseif ($file->writable): ?> 
    <div class="panel panel-success">
        <h3 class="has-icon">
            <?php self::e(__('%s file is writeable', 'loco-translate'), $file->type); ?> 
        </h3>
        <p>
            <?php esc_html_e(
    ...
    <div class="panel panel-locked">
        ...
        <p>
            <?php self::e(
            	__(
            		"To make changes you'll have to connect to the remote file system, or make the file writeable by %s",
            		'loco-translate',
            	),
            	$params->httpd,
            ); ?>.
    ...
    <div class="panel panel-error">
    	...
    	// Translators: "either" meaning that the file itself can't exist without a containing directory
    	esc_html_e(
    ...
    </div><?php // Translators: Where %s is the name (or number) of an operating system user
    	// Translators: Where %s is the name (or number) of an operating system user
    ...
    <div class="panel panel-success">
        ...
        <p>
            <?php self::e(
            	__(
            		'The containing directory is writeable by %s, so you can add new files in the same location',
            		'loco-translate',
            	),
            	$params->httpd,
            ); ?>.
    ...
    <div class="panel panel-locked">
        ...
        <p>
            <?php self::e(
            	__(
            		"To create new files here you'll have to connect to the remote file system, or make the directory writeable by %s",
            		'loco-translate',
            	),
            	$params->httpd,
            ); ?>.
    ...
    <div class="panel panel-info">
        <h3 class="has-icon"><?php esc_html_e('WordPress updates', 'loco-translate'); ?> 
        </h3>
        <p><?php esc_html_e(
            ...
            ); ?>"><?php esc_html_e("What's this?", 'loco-translate'); ?></a>
        </p>
    </div><?php endif;
    ...
    <div class="panel panel-debug">
        ...
        <div><?php foreach ($debug as $prop => $raw): ?> 
        <p><?php $debug->e($prop); ?></p><?php endforeach; ?> 
    </div><?php endif;
