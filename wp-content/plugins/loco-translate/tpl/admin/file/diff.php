        ...
        <form class="revisions-control-frame" action="" method="post" enctype="application/x-www-form-urlencoded">
            <div class="loco-clearfix">
                <div class="revisions-previous jshide">
                    <button type="button" class="button" disabled><?php echo esc_attr_x(
                    	'Previous',
            ...
            <div class="revisions-meta loco-clearfix">
                ...
                </div><?php /* @var Loco_mvc_FileParams[] $files */
                foreach ($files as $i => $file): ?> 
                <div class="diff-meta jshide">
                    <span><?php $file->e('name'); ?></span><br />
                    <time><?php $file->date('potime', $dfmt); ?></time><br />
                    <button type="submit" class="button button-primary" name="backup" value="<?php $file->e(
                    	'relpath',
                    ); ?>"><?php esc_html_e('Restore', 'loco-translate'); ?></button>
                    <button type="submit" class="button button-danger" name="delete" value="<?php $file->e(
                    	'relpath',
                    ); ?>"><?php esc_html_e('Delete', 'loco-translate'); ?></button>
                </div><?php endforeach; ?> 
            </div><?php /* @var Loco_mvc_HiddenFields $hidden */
            $hidden->_e(); ?> 
        </form>
