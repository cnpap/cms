...
if ($this->has('breadcrumb')): ?> 
    <h1>
        <ul><?php /* @var Loco_mvc_ViewParams[] $breadcrumb */
    ...
    </h1><?php elseif ($this->has('title')): ?> 
    <h1>
        <?php $params->e('title'); ?> 
    </h1><?php endif;

if ($this->has('tabs')): ?> 
    <h2 class="nav-tab-wrapper"><?php /* @var Loco_mvc_ViewParams[] $tabs */
    foreach ($tabs as $item): ?> 
        <a href="<?php $item->e('href'); ?>" class="nav-tab<?php echo $item->active
	? ' nav-tab-active'
	: ''; ?>">
            <?php $item->e('name'); ?> 
        </a><?php endforeach; ?> 
...
<?php /* @var null|Loco_mvc_ViewParams $js */
