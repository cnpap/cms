...
$this->extend('../layout'); ?> 
    ...
    <div class="panel panel-info">
        ...
        <p>
            <?php esc_html_e(
            	"This plugin doesn't have its own translation files, but can be translated in the default text domain",
            	'loco-translate',
            ); ?>.
        </p>
        <p>
            <a href="<?php $params->e('redirect'); ?>"><?php esc_html_e(
	'Go to WordPress Core',
	'loco-translate',
); ?></a>
        </p>
    </div>
