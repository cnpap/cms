...
$this->extend('../layout'); ?> 
    ...
    <?php foreach ($translations as $t => $group):
    	$type = $types[$t]; ?> 
    <div class="loco-projects">
        <h3>
            <?php $type->e('name'); ?> 
        </h3><?php echo $this->render('../common/inc-table-filter'); ?> 
        <table class="wp-list-table widefat fixed striped">
            ...
            <tbody><?php /* @var Loco_mvc_ViewParams $po */
            foreach ($group as $po): ?> 
                <tr>
	...
	'loco-translate',
                    ...
                    <td data-sort-value="<?php $po->f('time', '%u'); ?>">
                        <time datetime="<?php $po->date('time', 'Y-m-d H:i:s'); ?>"><?php $po->date(
	'time',
); ?></time>
                    </td>
                    <td>
        ...
        <p>
            <a href="<?php $type->e(
            	'href',
            ); ?>" class="button button-link has-raquo"><?php $type->e('text'); ?></a>
        </p>
    </div><?php
    endforeach;
