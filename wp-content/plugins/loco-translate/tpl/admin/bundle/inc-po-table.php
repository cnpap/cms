...
if ($pairs): ?> 
        ...
        <tbody><?php foreach ($pairs as $po):
            ...
            <tr>
                <td class="has-row-actions" data-sort-value="<?php $po->e('lname'); ?>">
                    <a href="<?php $po->e('edit'); ?>" class="row-title"><?php if ($ispo): ?> 
                        <span <?php echo $po->lattr; ?>><code><?php $po->e(
	'lcode',
); ?></code></span>
                        <span><?php $po->e('lname'); ?></span><?php else: ?> 
                    ...
                    <nav class="row-actions">
                        <span>
                            <a href="<?php $po->e('edit'); ?>"><?php esc_html_e(
	'Edit',
	'loco-translate',
); ?></a> |
                        </span>
                        <span>
                            <a href="<?php $po->e('view'); ?>"><?php esc_html_e(
	'View',
	'loco-translate',
); ?></a> |
                        </span>
                        <span>
                            <a href="<?php $po->e('info'); ?>"><?php esc_html_e(
	'Info',
	'loco-translate',
); ?></a> |
                        </span>
                        <span>
                            <a href="<?php $po->e('copy'); ?>"><?php esc_html_e(
	'Copy',
	'loco-translate',
); ?></a> |
                        </span>
                        <span>
                            <a href="<?php $po->e('move'); ?>"><?php esc_html_e(
	'Move',
	'loco-translate',
); ?></a> |
                        </span>
                        <span class="trash">
                            <a href="<?php $po->e('delete'); ?>"><?php esc_html_e(
	'Delete',
	'loco-translate',
); ?></a>
                        </span>
	...
	'time',
        ...
        endforeach; ?> 
        </tbody><?php /* @var string[] $warnings */
        if (isset($warnings) && is_array($warnings) && $warnings): ?> 
        <tfoot><?php foreach ($warnings as $text): ?> 
            <tr>
                <td colspan="8">
    ...
    <table class="wp-list-table widefat fixed striped">
        <tr>
            <td><?php self::e(
            	__('No translations found for "%s"', 'loco-translate'),
            	$domain,
            ); ?></td>
        </tr>
    </table><?php endif;
