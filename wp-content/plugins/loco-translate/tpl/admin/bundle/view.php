        ...
        <div class="panel panel-info">
            ...
            <p>
                <?php esc_html_e(
                	...
                	'loco-translate',
                ); ?>. <?php // Translators: %s is a URL. Keep the <a> tag intact
echo wp_kses(
	sprintf(
		__(
...
<div class="loco-project">
    <div class="panel panel-error">
        <h2><?php $params->e('name'); ?> <span>(<?php esc_html_e(
 	'unconfigured',
 	'loco-translate',
 ); ?>)</span></h2>
        <p>
            <?php esc_html_e(
            	"This bundle isn't automatically compatible and requires configuring before you can use all the functions of Loco Translate",
            	'loco-translate',
            ); ?>. <?php echo wp_kses(
	sprintf(
		__(
