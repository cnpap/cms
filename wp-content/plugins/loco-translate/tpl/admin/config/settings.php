...
$this->extend('../layout');
$help_url = esc_html(
	apply_filters('loco_external', 'https://localise.biz/wordpress/plugin/manual/settings'),
);
                    ...
                    <td>
                        <fieldset>
                            ...
                            <p>
                                ...
                                <input type="text" size="5" name="opts[max_php_size]" id="loco--max_php_size" value="<?php echo esc_attr(
                                	$opts->max_php_size,
                                ); ?>" placeholder="<?php echo esc_attr($dflt->max_php_size); ?>" />
                            </p>
                            <p>
                                <label for="loco--php_alias">
                                    <?php esc_html_e(
                                    	'Scan PHP files with extensions:',
                                    	'loco-translate',
                                    ); ?>
                                </label>
                                <input type="text" size="15" name="opts[php_alias]" id="loco--php_alias" value="<?php echo esc_attr(
                                	implode(' ', $opts->php_alias),
                                ); ?>" placeholder="<?php echo esc_attr(
	implode(' ', $dflt->php_alias),
); ?>" />
                            </p>
                            <p>
                                <label for="loco--jsx_alias">
                                    <?php esc_html_e(
                                    	'Scan JavaScript files with extensions:',
                                    	'loco-translate',
                                    ); ?>
                                </label>
                                <input type="text" size="15" name="opts[jsx_alias]" id="loco--jsx_alias" value="<?php echo esc_attr(
                                	implode(' ', $opts->jsx_alias),
                                ); ?>" placeholder="<?php echo esc_attr(
	implode(' ', $dflt->jsx_alias),
); ?>" />
                            </p>
                        </fieldset>
                    </td>
                    ...
                    <td>
                        <fieldset>
                            ...
                            <p>
                                ...
                                <input type="number" min="0" max="99" size="2" name="opts[num_backups]" id="loco--num-backups" value="<?php printf(
                                	'%u',
                                	$opts->num_backups,
                                ); ?>" />
                            </p>
                            <p>
                                <label for="loco--po-width">
                                    <?php esc_html_e(
                                    	'Maximum line length (zero disables wrapping)',
                                    	'loco-translate',
                                    ); ?> 
                                </label>
                                <input type="number" min="0" max="999" size="2" name="opts[po_width]" id="loco--po-width" value="<?php printf(
                                	'%u',
                                	$opts->po_width,
                                ); ?>" />
                            </p>
                            <p>
                                <label for="loco--po-utf8-bom">
                                    <input type="checkbox" name="opts[po_utf8_bom]" value="1" id="loco--po-utf8-bom"<?php echo $opts->po_utf8_bom
                                    	? ' checked'
                                    	: ''; ?> />
                                    <?php esc_html_e(
 	...
 	'loco-translate',
                            ...
                            <p>
                                <label for="loco--ajax-files">
                                    <input type="checkbox" name="opts[ajax_files]" value="1" id="loco--ajax-files"<?php echo $opts->ajax_files
                                    	? ' checked'
                                    	: ''; ?> />
                                    <?php esc_html_e(
                                    	'Enable Ajax file uploads',
                                    	'loco-translate',
                                    ); ?> (<?php esc_html_e('Recommended', 'loco-translate'); ?>)
                                </label>
                            </p>
                        </fieldset>
                    </td>
                    ...
                    <td>
                        <fieldset>
                            ...
                            <p>
                                ...
                                <input type="text" size="5" maxlength="3" name="opts[fuzziness]" id="loco--fuzziness" value="<?php echo esc_attr(
                                	$opts->fuzziness,
                                ); ?>" placeholder="0-100" />
                                <span>%</span>
                            </p>
...
esc_html_e('Sync with source when template missing', 'loco-translate'); ?>:
                                ...
                                <select name="opts[pot_expected]" id="loco--pot-expected">
                                    ...
                                    <option value="1"<?php echo 1 === $opts->pot_expected
                                    	? ' selected'
                                    	: ''; ?>><?php $verbose->e(1); ?></option>
                                    <option value="2"<?php echo 2 === $opts->pot_expected
                                    	? ' selected'
                                    	: ''; ?>><?php $verbose->e(2); ?></option>
                                </select>
                            </p>
                        </fieldset>
                    </td>
                        ...
                        <fieldset>
                            ...
                            <p>
                                <label for="loco--gen-hash">
                                    <input type="checkbox" name="opts[gen_hash]" value="1" id="loco--gen-hash"<?php echo $opts->gen_hash
                                    	? ' checked'
                                    	: ''; ?> />
                            ...
                            <p>
                                <label for="loco--use-fuzzy">
                                    <input type="checkbox" name="opts[use_fuzzy]" value="1" id="loco--use-fuzzy"<?php echo $opts->use_fuzzy
                                    	? ' checked'
                                    	: ''; ?> />
                        ...
                        <fieldset>
                            ...
                            <p>
                                <label for="loco--jed-pretty">
                                    <input type="checkbox" name="opts[jed_pretty]" value="1" id="loco--jed-pretty"<?php echo $opts->jed_pretty
                                    	? ' checked'
                                    	: ''; ?> />
                            ...
                            <p>
                                <label for="loco--jed-clean">
                                    <input type="checkbox" name="opts[jed_clean]" value="1" id="loco--jed-clean"<?php echo $opts->jed_clean
                                    	? ' checked'
                                    	: ''; ?> />
                        ...
                        <fieldset>
                            ...
                            <p>
                                <label for="loco--fs-persist">
                                    <input type="checkbox" name="opts[fs_persist]" value="1" id="loco--fs-persist"<?php echo $opts->fs_persist
                                    	? ' checked'
                                    	: ''; ?> />
                                    <?php esc_html_e(
                            ...
                            <p>
                                ...
                                <select name="opts[fs_protect]" id="loco--fs-protect">
                                    <option value="0"><?php $verbose->e(0); ?></option>
                                    <option value="1"<?php echo 1 === $opts->fs_protect
                                    	? ' selected'
                                    	: ''; ?>><?php $verbose->e(1); ?></option>
                                    <option value="2"<?php echo 2 === $opts->fs_protect
                                    	? ' selected'
                                    	: ''; ?>><?php $verbose->e(2); ?></option>
                                </select>
                            </p>
                            <p>
                                <label for="loco--pot-protect">
                                    <?php esc_html_e(
                                    	'Editing of POT (template) files',
                                    	'loco-translate',
                                    ); ?>:
                                </label>
                                <select name="opts[pot_protect]" id="loco--pot-protect">
                                    <option value="0"><?php $verbose->e(0); ?></option>
                                    <option value="1"<?php echo 1 === $opts->pot_protect
                                    	? ' selected'
                                    	: ''; ?>><?php $verbose->e(1); ?></option>
                                    <option value="2"<?php echo 2 === $opts->pot_protect
                                    	? ' selected'
                                    	: ''; ?>><?php $verbose->e(2); ?></option>
                                </select>
                            </p>
                ...
                <tr>
                    ...
                    <td>
                        <fieldset>
                            ...
                            </legend><?php /* @var Loco_mvc_ViewParams[] $caps */
                            foreach ($caps as $cap): ?> 
                            <p>
                                <label>
                                    <input type="checkbox" name="<?php $cap->e(
                                    	'name',
                                    ); ?>" value="<?php $cap->e(
	'label',
); ?>" <?php echo $cap->attrs; ?> />
        ...
        <p class="submit">
            ...
            <a class="button button-link" href="<?php echo $help_url; ?>" target="_blank"><?php esc_html_e(
	'Documentation',
	'loco-translate',
); ?></a>
        </p>
