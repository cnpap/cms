...
<form action="" method="post" enctype="application/x-www-form-urlencoded">
    ...
    <table class="form-table">
        ...
        $api = $apis['deepl']; ?> 
                ...
                <td>
                    <fieldset>
                        ...
                        <p>
                            ...
                            <input type="text" size="50" name="api[deepl][key]" id="loco--deepl_api_key" value="<?php $api->e(
                            	'key',
                            ); ?>" spellcheck="false" />
                        </p>
                        <p>
                ...
                <td>
                    <fieldset>
                        ...
                        <p>
                            ...
                            <input type="text" size="50" name="api[google][key]" id="loco--google_api_key" value="<?php $api->e(
                            	'key',
                            ); ?>" spellcheck="false" />
                        </p>
                        <p>
                ...
                <td>
                    <fieldset>
                        ...
                        <p>
                            ...
                            <input type="text" size="50" name="api[lecto][key]" id="loco--lecto_api_key" value="<?php $api->e(
                            	'key',
                            ); ?>" spellcheck="false" />
                        </p>
                        <p>
                ...
                <td>
                    <fieldset>
                        ...
                        <p>
                            ...
                            <input type="text" size="50" name="api[microsoft][key]" id="loco--microsoft_api_key" value="<?php $api->e(
                            	'key',
                            ); ?>" spellcheck="false" />
                        </p>
                        <p>
                            ...
                            <input type="text" size="20" name="api[microsoft][region]" id="loco--microsoft_api_region" value="<?php $api->e(
                            	'region',
                            ); ?>" spellcheck="false" placeholder="global" />
                        </p>
                        <p>
                ...
                <td>
                    <fieldset>
                        ...
                        <p>
                            ...
                            <input type="text" size="50" name="api[openai][key]" id="loco--openai_api_key" value="<?php $api->e(
                            	'key',
                            ); ?>" spellcheck="false" />
                        </p>
                        <p>
                            ...
                            <input type="text" size="50" name="api[openai][model]" id="loco--openai_api_model" value="<?php $api->e(
                            	'model',
                        ...
                        <p>
                            ...
                            <textarea class="regular-text" name="api[openai][prompt]" id="loco--openai_prompt"><?php $api->e(
                            	'prompt',
                            ); ?></textarea>
                        </p>
                        <p>
            ...
            </tr><?php /* @var Loco_mvc_ViewParams[] $hooked */
            foreach ($hooked as $api): ?> 
            <tr>
                <th scope="row"><?php $api->e('name'); ?></th>
                <td>
                    <p><?php $api->key
                    	? esc_html_e('Configured externally', 'loco-translate')
                    	: esc_html_e('No API key', 'loco-translate'); ?><br />
                        <span class="description"><a href="<?php $api->e(
                        	'url',
                        ); ?>" target="_blank" tabindex="-1"><?php $api->e('url'); ?></a></span>
                    </p>
                </td>
            </tr><?php endforeach; ?> 
        </tbody>
    ...
    <div class="panel">
        <p>
            ...
            <span>
                <?php esc_html_e(
                	'Third party services are subject to their own terms of use and may incur costs from the provider',
                	'loco-translate',
                ); ?>.
                <a href="<?php self::e(
                	$help,
                ); ?>#legal" target="_blank" tabindex="-1"><?php esc_html_e(
	'See full disclaimer',
	'loco-translate',
); ?></a>.
            </span>
    ...
    <p class="submit">
        ...
        <a class="button button-link" href="<?php self::e(
        	$help,
        ); ?>" target="_blank"><?php esc_html_e('Documentation', 'loco-translate'); ?></a>
    </p>
</form>
