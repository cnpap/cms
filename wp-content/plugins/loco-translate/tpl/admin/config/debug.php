...
?> 
        ...
        <div class="panel" id="loco-versions">
            ...
            <dl><?php foreach ($versions as $key => $value):
            	if ($value): ?> 
                <dt>
                    <?php self::e($key); ?>:
                </dt>
                <dd>
                    <code class="path" id="loco-vers-<?php self::e(
                    	strtolower(strtr($key, ' ', '-')),
                    ); ?>"><?php $versions->e($key); ?></code>
                </dd><?php endif;
            endforeach; ?> 
            </dl>
        </div>
        ...
        <div class="panel" id="loco-apis">
            ...
            <dl><?php /* @var Loco_mvc_ViewParams[] $apis */
            foreach ($apis as $api): ?> 
                <dt><?php $api->e('name'); ?>:</dt>
                <dd class="jsonly" id="loco-api-<?php $api->e(
                	'id',
                ); ?>"><span class="inline-spinner"> </span></dd><?php endforeach; ?> 
            </dl>
        </div>
        ...
        <div class="panel" id="loco-sizes">
            ...
            <dl><?php /* @var Loco_mvc_ViewParams $memory */
        ...
        <div class="panel" id="loco-files">
            ...
            <dl>
                ...
                <dd><?php $fs->e(
                	'fs_protect',
                ); ?></dd><?php /* @var Loco_mvc_ViewParams[] $locations */
foreach ($locations as $label => $f): ?> 
        ...
        <div class="panel" id="loco-debug">
            ...
            <dl><?php foreach ($debug as $key => $value): ?> 
                <dt>
