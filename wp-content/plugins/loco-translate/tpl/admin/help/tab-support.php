...
<p>
    ...
    but please check the <a href="<?php echo esc_url(
    	apply_filters('loco_external', 'https://localise.biz/wordpress/plugin/faqs'),
    ); ?>">FAQs</a> 
    for similar issues first. If you decide to submit a bug report please post enough
    <a href="<?php echo esc_url(
    	apply_filters('loco_external', 'https://localise.biz/wordpress/plugin/faqs/debug-info'),
    ); ?>">relevant detail</a>
