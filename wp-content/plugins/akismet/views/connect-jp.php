...
<div class="akismet-box">
	...
	<div class="akismet-jp-connect">
    	...
    	Akismet_Admin::get_page_url(),
				...
				<input type="submit" class="akismet-button akismet-is-primary" value="<?php esc_attr_e(
    	'Connect with Jetpack',
    	'akismet',
    ); ?>"/>
			</form>
			<?php echo get_avatar($akismet_user->user_email, null, null, null, [
   	'class' => 'akismet-jetpack-gravatar',
   ]); ?>
			<p>
				<?php /* translators: %s is the WordPress.com username */
    printf(
    	esc_html(__('You are connected as %s.', 'akismet')),
    	'<b>' . esc_html($akismet_user->user_login) . '</b>',
    ); ?>
				<br />
   	...
   	'class' => 'akismet-jetpack-gravatar',
			...
			<p>
				<?php /* translators: %s is the WordPress.com email address */
    echo esc_html(
    	sprintf(__('Your subscription for %s is cancelled.', 'akismet'), $akismet_user->user_email),
    ); ?>
				<br />
				<span class="akismet-jetpack-email"><?php echo esc_html($akismet_user->user_email); ?></span>
			</p>
		<?php } elseif ($akismet_user->status == 'suspended') { ?>
			<div class="akismet-right">
				<p><a href="https://akismet.com/contact" class="akismet-button akismet-is-primary"><?php esc_html_e(
     ...
     echo esc_html(
     	sprintf(
     		__('Your subscription for %s is suspended.', 'akismet'),
	...
	<div class="centered akismet-toggles">
		...
		<a href="#" class="toggle-ak-connect"><?php esc_html_e(
