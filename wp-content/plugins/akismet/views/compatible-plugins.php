...
if (is_array($compatible_plugins)):
	...
	<div class="akismet-card akismet-compatible-plugins">
		<div class="akismet-section-header">
			<h2 class="akismet-section-header__label  akismet-compatible-plugins__section-header-label" aria-label="<?php esc_attr_e(
   	'Compatible plugins (new feature)',
   	'akismet',
   ); ?>">
				<span class="akismet-compatible-plugins__section-header-label-text"><?php esc_html_e(
    	'Compatible plugins',
    	'akismet',
    ); ?></span>
     	...
     	if (empty($compatible_plugin['help_url'])) {
        	...
        	$compatible_plugin['name'],
							...
							<div class="akismet-compatible-plugins__card-detail">
								<h3 class="akismet-compatible-plugins__card-title"><?php echo esc_html(
        	$compatible_plugin['name'],
        ); ?></h3>
     ...
     endforeach; ?>
				...
				<?php if ($compatible_plugin_count > Akismet_Compatible_Plugins::DEFAULT_VISIBLE_PLUGIN_COUNT): ?>
					<button class="akismet-compatible-plugins__show-more"
						...
						data-label-closed="
							<?php /* translators: %d: number of compatible plugins, which is guaranteed to be more than 1. */
